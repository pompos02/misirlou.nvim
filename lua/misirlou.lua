...
local function set_highlights()
    ...
    local default_highlights = {
        ...
        Visual = { bg = palette.blue, blend = 50 },
        ...
        LspSagaRenameBorder = make_border(palette.blue),
        ...
        BlinkCmpDocBorder = { fg = palette.subtle, bg = palette.bg },
        ...
        SnacksPickerBorder = { fg = palette.subtle, bg = palette.bg },
