...
local function set_highlights()
    ...
    local default_highlights = {
        ...
        PmenuExtraSel = { fg = "#000000", bg = palette.green },
        PmenuKind = { fg = palette.lavender, bg = palette.bg },
        PmenuKindSel = { fg = "#000000", bg = palette.green },
        PmenuMatch = { fg = palette.green },
        PmenuMatchSel = { fg = "#000000", bg = palette.green },
        PmenuSbar = { bg = palette.bg },
        PmenuSel = { fg = "#000000", bg = palette.green },
        ...
        Search = { fg = palette.text, bg = palette.lavender, blend = 80 },
